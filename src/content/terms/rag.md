...
ファインチューニングと似ていますが、RAG は外部検索で補う方式、ファインチューニングはモデル自体を再学習して性質を変える方式です。

## ③ もっと知りたい人向け

- 公式サイト/公式ドキュメント: [Google検索: Retrieval-Augmented Generation official documentation](https://www.google.com/search?q=Retrieval-Augmented+Generation+official+documentation)
