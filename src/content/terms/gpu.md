...
CPU と似ていますが、GPU は並列計算特化、CPU は汎用制御と分岐処理に強いという違いがあります。

## ③ もっと知りたい人向け

- 公式サイト/公式ドキュメント: [Google検索: Graphics Processing Unit official documentation](https://www.google.com/search?q=Graphics+Processing+Unit+official+documentation)
