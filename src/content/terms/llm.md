...
RAG と似ていますが、LLM は生成モデル本体、RAG は外部文書検索を組み合わせて回答精度を上げる実装方式です。

## ③ もっと知りたい人向け

- 公式サイト/公式ドキュメント: [Google検索: Large Language Model official documentation](https://www.google.com/search?q=Large+Language+Model+official+documentation)
