...
- 公式サイト/公式ドキュメント:
  - [Google検索: Application Programming Interface official documentation](https://www.google.com/search?q=Application+Programming+Interface+official+documentation)
