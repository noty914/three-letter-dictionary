...
結合テストと似ていますが、結合テストは機能連携の技術確認、UAT は業務受け入れ判断が目的です。

## ③ もっと知りたい人向け

- 公式サイト/公式ドキュメント: [Google検索: User Acceptance Testing official documentation](https://www.google.com/search?q=User+Acceptance+Testing+official+documentation)
